                ...
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link"
                            onclick="window.location = '{{ route('admin.catalog.categories.index') }}'"></i>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <accordian title="{{ __('admin::app.catalog.categories.description-and-images') }}"
                        ...
                        <div slot="body">
                            ...
                            <div class="control-group {!! $errors->has('image.*') ? 'has-error' : '' !!}">
                                ...
                                <span
                                    class="control-info mt-10">{{ __('admin::app.catalog.categories.image-size') }}</span>
                            </div>
                    ...
                    @if ($categories->count())
                        ...
                        <accordian title="{{ __('admin::app.catalog.categories.parent-category') }}"
                            :active="true">
                            <div slot="body">
                    ...
                    <accordian title="{{ __('admin::app.catalog.categories.filterable-attributes') }}"
                        ...
                        <div slot="body">
                            ...
                            <div class="control-group multi-select"
                                :class="[errors.has('attributes[]') ? 'has-error' : '']">
                                ...
                                <select class="control" name="attributes[]" v-validate="'required'"
                                    data-vv-as="&quot;{{ __('admin::app.catalog.categories.attributes') }}&quot;" multiple>
                    ...
                    <accordian title="{{ __('admin::app.catalog.categories.seo') }}" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group">
                                <label
                                    for="meta_description">{{ __('admin::app.catalog.categories.meta_description') }}</label>
