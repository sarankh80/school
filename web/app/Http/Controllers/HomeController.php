...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['dashboard'] = [
            ...
            'top_services_list'                 => BookingItem::myBooking()->showServiceCount()->take(5)->get(),
        ...
        $data['category_chart'] = [
            'chartdata'     => BookingItem::myBooking()->showServiceCount()->take(4)->get()->pluck('count_pid'),
            'chartlabel'    => BookingItem::myBooking()->showServiceCount()->take(4)->get()->pluck('service.category.name')
        ];
    ...
    public function changeStatus(Request $request)
    {
        ...
        switch ($type) {
            ...
            case 'provideraddress_status' :
                $provideraddress = \App\Models\Address::find($request->id);
    ...
    public function getAjaxList(Request $request) 
    {
        ...
        switch ($request->type) {
            ...
            case 'provider_address':
                ...
                $items = \App\Models\Address::select('id','address as text','latitude','longitude','status')->where('addressable_id', $provider_id)->where('status',1);
                $items = $items->get();
                break;
