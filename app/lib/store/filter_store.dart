...
abstract class FilterStoreBase with Store {
  ...
  @observable
  int selectedSub1CategoryId = 0;

  @observable
  int selectedSubBrandId = 0;
  ...
  @action
  Future<void> setSelectedSub1Category({required int catId}) async {
    selectedSub1CategoryId = catId;
  }

  @action
  Future<void> setSelectedSubBrand({required int brandId}) async {
    selectedSubBrandId = brandId;
  }
