...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> update() async {
    ...
    MultipartRequest multiPartRequest =
        await getMultiPartRequest('update-profile?id=${appStore.userId}');
      ...
      onSuccess: (data) async {
        ...
        if (data != null) {
          if ((data as String).isJson()) {
            ...
            log("afterupdate : ${appStore.isLoggedIn}");
            finish(context);
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextField(
                ...
                //     return '"-" required after country code';
                //   return null;
                // },
              ),
              // 4.height,
