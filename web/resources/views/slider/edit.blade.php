    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($slider, ['method' => 'POST', 'route' => ['sliders.update', $slider->id], 'enctype' => 'multipart/form-data', 'data-toggle' => 'validator', 'id' => 'slider']) }}
                        {{ Form::hidden('id') }}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::select(
                                    'type_id',
                                    [optional($slider->service)->id => optional($slider->service)->name],
                                    optional($slider->service)->id,
                                    [
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-control-label" for="slider_image">{{ __('messages.image') }}
                                </label>
                            ...
                            @if (getMediaFileExit($slider, 'slider_image'))
                                <div class="col-md-2 mb-2">
                                    <img id="slider_image_preview" src="{{ getSingleMedia($slider, 'slider_image') }}"
                                        alt="#" class="attachment-image mt-1">
                                    <a class="text-danger remove-file"
                                        href="{{ route('remove.file', ['id' => $slider->id, 'type' => 'slider_image']) }}"
