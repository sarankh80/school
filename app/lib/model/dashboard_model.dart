...
class DashboardResponse {
  ...
  List<ServiceData>? discountProducts;
  List<ServiceData>? discountService;
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) {
    return DashboardResponse(
      ...
      termConditions: json['term_conditions'] != null
          ? PrivacyPolicy.fromJson(json['term_conditions'])
          : null,
      ...
      languageOption: json['language_option'] != null
          ? (json['language_option'] as List)
              ...
              .toList()
          : null,
      discountProducts: json['discount_products'] != null
          ? (json['discount_products'] as List)
              .map((i) => ServiceData.fromJson(i))
              .toList()
          : null,
      discountService: json['discount_service'] != null
          ? (json['discount_service'] as List)
              .map((i) => ServiceData.fromJson(i))
              .toList()
          : null,
    );
...
class PaymentSetting {
  ...
  factory PaymentSetting.fromJson(Map<String, dynamic> json) {
    return PaymentSetting(
      ...
      type: json['type'],
      testValue:
          json['value'] != null ? LiveValue.fromJson(json['value']) : null,
