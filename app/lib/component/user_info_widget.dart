import 'package:com.gogospider.booking/component/disabled_rating_bar_widget.dart';
...
class UserInfoWidget extends StatelessWidget {
  ...
  UserInfoWidget(
      {required this.data, this.isOnTapEnabled, this.forProvider = true});
                ...
                Row(
                  ...
                  children: [
                        ...
                        if (data.designation.validate().isNotEmpty)
                          Column(
                            children: [
                              4.height,
                              Marquee(
                                  child: Text(data.designation.validate(),
                    ...
                    Image.asset(ic_verified,
                        ...
                        .visible(data.isVerifyProvider == 1),
                  ],
                ),
                10.height,
                DisabledRatingBarWidget(
                    rating: forProvider
                        ? data.providersServiceRating.validate()
                        : data.handymanRating.validate()),
              ],
            ).expand(),
          ],
        ),
