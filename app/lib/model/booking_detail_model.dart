...
class BookingDetailResponse {
  ...
  bool get isProviderAndHandymanSame => handymanData.validate().isNotEmpty
      ? handymanData.validate().first.id.validate() ==
          providerData!.id.validate()
      : false;
  ...
  factory BookingDetailResponse.fromJson(Map<String, dynamic> json) {
    return BookingDetailResponse(
      bookingActivity: json["data"]['activities']["data"] != null
          ? (json["data"]['activities']["data"] as List)
              .map((i) => BookingActivity.fromJson(i))
              .toList()
          : null,
      bookingDetail:
      ...
      customer: json["data"]['customer'] != null
          ? UserData.fromJson(json["data"]['customer'])
          : null,
      handymanData: json["data"]['handyman'] != null
          ? (json["data"]['handyman'] as List)
              .map((i) => UserData.fromJson(i["handyman"]))
              .toList()
          : null,
      // ratingData: json['rating_data'] != null ? (json['rating_data'] as List).map((i) => RatingData.fromJson(i)).toList() : null,
      providerData: json["data"]['provider'] != null
          ? UserData.fromJson(json["data"]['provider']["data"])
          : null,
...
class BookingActivity {
  ...
  factory BookingActivity.fromJson(Map<String, dynamic> json) {
    return BookingActivity(
      activityData: json['name'],
      activityMessage: json['description'],
      activityType: json['event'],
      bookingId: json['id'],
