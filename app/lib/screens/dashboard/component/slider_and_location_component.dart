...
class SliderLocationComponent extends StatefulWidget {
  ...
  SliderLocationComponent(
      {required this.sliderList, this.notificationReadCount, this.callback});
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
                    ...
                    (index) {
                      ...
                      return CachedImageWidget(
                        ...
                        if (data.type == 'service') {
                          // ViewDetail(service: data).launch(context);
                          // ServiceDetailScreen(
          ...
          //                     child: FittedBox(
          //                       child: Text(
          //                           widget.notificationReadCount.toString(),
