...
class CustomerController extends Controller
{
     ...
     *
     * @var App\Repositories\CustomerGroupRepository
     */
    ...
    public function register(CustomerRegisterRequest $request)
    {
        ...
        $response = [
            'message' => trans('messages.save_form', ['form' => trans('messages.customer')]),
    ...
    public function login(CustomerLoginRequest $request)
    {
        ...
        $customer = $this->customerRepository->whereNotNull('phone_verified_at')->where('phone_number', $request->phone_number)->first();
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse($customers, 'Customers list successfully');

        $user_type = isset($request->user_type) ? $request->user_type : 'handyman';

        $customers = $this->customerRepository->get();

        $handyman_list = Customer::where('user_type', $user_type)->where('status', 1)->withTrashed();
    ...
    public function socialLogin(Request $request)
    {
        ...
        if ($input['login_type'] === 'mobile') {
            $user_data = Customer::where('username', $input['username'])->where('login_type', 'mobile')->first();
        } else {
            $user_data = Customer::where('email', $input['email'])->first();
        }
        ...
        if ($user_data != null) {
            ...
            $trashed_user_data = Customer::where($key, $value)->whereNotNull('login_type')->withTrashed()->first();
            ...
            $user_data = Customer::where('id', $user->id)->first();
