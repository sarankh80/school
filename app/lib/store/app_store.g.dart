...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$isSelectedAtom =
      Atom(name: '_AppStore.isSelected', context: context);
  ...
  late final _$isCustomeLocationAtom =
      Atom(name: '_AppStore.isCustomeLocation', context: context);

  @override
  bool get isCustomeLocation {
    _$isCustomeLocationAtom.reportRead();
    return super.isCustomeLocation;
  }

  @override
  set isCustomeLocation(bool value) {
    _$isCustomeLocationAtom.reportWrite(value, super.isCustomeLocation, () {
      super.isCustomeLocation = value;
    });
  }
  ...
  late final _$addressImageAtom =
      Atom(name: '_AppStore.addressImage', context: context);

  @override
  String get addressImage {
    _$addressImageAtom.reportRead();
    return super.addressImage;
  }

  @override
  set addressImage(String value) {
    _$addressImageAtom.reportWrite(value, super.addressImage, () {
      super.addressImage = value;
    });
  }
  ...
  @override
  ObservableFuture<void> setPlayerId(String val,
      {bool isInitializing = false}) {
    return ObservableFuture<void>(_$setPlayerIdAsyncAction
  ...
  late final _$setSavedLocationAsyncAction =
      AsyncAction('_AppStore.setSavedLocation', context: context);

  @override
  Future<void> setSavedLocation(bool val, {bool isInitializing = false}) {
    return _$setSavedLocationAsyncAction
        .run(() => super.setSavedLocation(val, isInitializing: isInitializing));
  }

  late final _$setCustomeLocationAsyncAction =
      AsyncAction('_AppStore.setCustomeLocation', context: context);
  @override
  Future<void> setCustomeLocation(bool val, {bool isInitializing = false}) {
    return _$setCustomeLocationAsyncAction.run(
        () => super.setCustomeLocation(val, isInitializing: isInitializing));
  }

  late final _$setAlertChooseLocationAsyncAction =
      AsyncAction('_AppStore.setAlertChooseLocation', context: context);

  @override
  Future<void> setAlertChooseLocation(bool val, {bool isInitializing = false}) {
    return _$setAlertChooseLocationAsyncAction.run(() =>
        super.setAlertChooseLocation(val, isInitializing: isInitializing));
  }

  late final _$setHomeCategoryAsyncAction =
      AsyncAction('_AppStore.setAlertChooseLocation', context: context);

  @override
  Future<void> setHomeCategory(bool val, {bool isInitializing = false}) {
    return _$setHomeCategoryAsyncAction
        .run(() => super.setHomeCategory(val, isInitializing: isInitializing));
  }
  ...
  late final _$cartItemsAtom =
      Atom(name: '_AppStore.cartItems', context: context);
  ...
  late final _$setSavedAddressAsyncAction =
      AsyncAction('_AppStore.setSavedAddress', context: context);

  @override
  Future<void> setSavedAddress(List<SavedAddress> val) {
    return _$setSavedAddressAsyncAction.run(() => super.setSavedAddress(val));
  }
  ...
  @override
  void setNotificationCount(int val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(
        name: '_AppStore.setNotificationCount');
    try {
      return super.setNotificationCount(val);
    } finally {
      _$_AppStoreActionController.endAction(_$actionInfo);
    }
  }
...
isCustomeLocation: ${isCustomeLocation},
