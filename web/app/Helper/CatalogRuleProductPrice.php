...
use App\Repositories\CatalogRuleProductPriceRepository;
...
class CatalogRuleProductPrice
{
     ...
     *
     * @param  App\Repositories\CatalogRuleProductPriceRepository  $catalogRuleProductPriceRepository
     * @param  App\Repositories\CatalogRuleProduct  $catalogRuleProductHelper
     * @param  AppRepositories\CustomerRepository  $customerRepository
     * @return void
     */
    ...
    public function getRulePrice($product)
    {
        ...
        return $this->catalogRuleProductPriceRepository->checkInLoadedCatalogRulePrice($product, optional($this->customerGroup)->id);
    }
}