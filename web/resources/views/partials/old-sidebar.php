...
@php
    ...
    $MyNavBar = \Menu::make('MenuList', function ($menu) use($url){
        ...
        $menu->add('<span>'.__('messages.category').'</span>', ['class' => ''])
            ...
            $menu->category->add('<span>'.__('messages.list_form_title',['form' => trans('messages.category') ]).'</span>', [ 'class' => 'sidebar-layout' , 'route' => ['categories.index']])
                ->prepend('<i class="ri-list-unordered"></i>')
                ->data('permission', 'category list')
                ->link->attr(array('class' => ''));

            $menu->category->add('<span>'.__('messages.add_form_title',['form' => trans('messages.category')]).'</span>', array( 'class' => 'sidebar-layout', 'route' => 'categories.create'))
        ...
        $menu->add('<span>'.trans('messages.service').'</span>', ['class' => ''])
                ...
                $menu->service->add('<span>'.trans('messages.list_form_title',['form' => trans('messages.service')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'services.index'])
                    ->prepend('<i class="ri-list-unordered"></i>')
                    ->data('permission', 'service list')
                    ->link->attr(['class' => '']);

                $menu->service->add('<span>'.trans('messages.add_form_title',['form' => trans('messages.service')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'services.create'])
        ...
        $menu->add('<span>'.__('messages.provider').'</span>', ['class' => ''])
                ...
                $menu->provider->add('<span>'.__('messages.list_form_title',['form' => __('messages.provider')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'providers.index'])
                    ->data('permission', 'provider list')
                    ->prepend('<i class="ri-list-unordered"></i>')
                    ->link->attr(['class' => '']);

                $menu->provider->add('<span>'.__('messages.add_form_title',['form' => __('messages.provider')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'providers.create'])
        ...
        $menu->add('<span>'.__('messages.provider_address').'</span>', ['class' => ''])
                ...
                $menu->provideraddress->add('<span>'.__('messages.list_form_title',['form' => __('messages.provider_address')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'addresses.index'])
                    ->data('permission', 'provideraddress list')
                    ->prepend('<i class="ri-list-unordered"></i>')
                    ->link->attr(['class' => '']);

                $menu->provideraddress->add('<span>'.__('messages.add_form_title',['form' => __('messages.provider_address')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'addresses.create'])
        ...
        $menu->add('<span>'.__('messages.users').'</span>', ['route' => 'users.index'])
                ->prepend('<i class="ri-list-unordered"></i>')
                ->nickname('user')
        ...
        $menu->add('<span>'.__('messages.slider').'</span>', ['class' => ''])
                ...
                $menu->sliders->add('<span>'.__('messages.list_form_title',['form' => __('messages.slider')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'sliders.index'])
                    ->data('permission', 'slider list')
                    ->prepend('<i class="ri-list-unordered"></i>')
                    ->link->attr(['class' => '']);

                $menu->sliders->add('<span>'.__('messages.add_form_title',['form' => __('messages.slider')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'sliders.create'])
