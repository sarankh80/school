            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12">
                                {{ Breadcrumbs::render('show_admin', $admin->id) }}
                            </div>
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    @if (count($admin->booking) > 0)
                                                        @foreach ($admin->booking as $booking)
                                                            <tr class="white-space-no-wrap">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            {{ date('D, d M Y', strtotime($booking->date)) }}
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>{{ optional($booking->provider)->display_name ?? '-' }}
                                                                </td>
                                                                <td class="text-right">
                                                                    {{ getPriceFormat($booking->total_amount ?? '0') }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    @else
                                                        <tr>
                                                            <td colspan="5" class="text-center font-weight-bold">
                                                                {{ __('messages.record_not_found') }}</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    @if (count($admin_pending_trans) > 0)
                                                        @foreach ($admin_pending_trans as $pending)
                                                            <tr class="white-space-no-wrap">
                                                                <td>{{ $pending->booking->service->name }}</td>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        {{ date('D, d M Y', strtotime($pending->booking->date)) }}
                                                                    </div>
                                                                </td>
                                                                <td>{{ $pending->payment_status }}</td>
                                                                <td class="text-right">
                                                                    {{ getPriceFormat($pending->total_amount) }}</td>
                                                            </tr>
                                                        @endforeach
                                                    @else
                                                        <tr>
