...
class ProductsComponent extends StatefulWidget {
  ...
  ProductsComponent({required this.serviceList, this.categoryList});

  @override
  State<StatefulWidget> createState() => _ProductsComponentState();
}
                ...
                ViewAllLabel(
                  ...
                  onTap: () {
                    ...
                    if (getDoubleAsync(BOOKING_LATITUDE) != 0.00 &&
                      ...
                      // SearchListScreen().launch(context);
                      MenuComponentList(
                              categoryList: widget.categoryList, id: 1)
                          .launch(context);
                    } else {
                      BookingServiceLocationFilter(
                              categoryData: widget.categoryList![0], isCat: 1)
                          .launch(context);
                    }
                  },
                ),
                ...
                HorizontalList(
                  ...
                  itemBuilder: (context, index) {
                    return ProductsWidget(
                        ...
                        categoryData: widget.categoryList![0],
