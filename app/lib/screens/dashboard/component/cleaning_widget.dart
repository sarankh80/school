...
class CleaningWidget extends StatefulWidget {
  ...
  @override
  CleaningWidgetState createState() => CleaningWidgetState();
}

class CleaningWidgetState extends State<CleaningWidget> {
  @override
  void initState() {
    super.initState();
    init();
                ...
                Row(
                  ...
                  children: [
                    ...
                    if (widget.serviceData!.discount.validate() > 0)
                      PriceWidget(
                        price: widget.serviceData!.discount.validate(),
                        isHourlyService: widget.serviceData!.isHourlyService,
