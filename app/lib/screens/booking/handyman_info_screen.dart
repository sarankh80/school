            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  16.height,
                  if (snap.data!.userData!.description.validate().isNotEmpty)
                    aboutWidget(
                        desc: snap.data!.userData!.description.validate()),
                  ...
                  ViewAllLabel(
                    ...
                    onTap: () {
                      RatingViewAllScreen(handymanId: snap.data!.userData!.id)
                          .launch(context);
                    },
                  ),
                  snap.data!.handymanRatingReviewList.validate().isNotEmpty
                      ? AnimatedListView(
                          ...
                          itemCount: snap.data!.handymanRatingReviewList
                              .validate()
                              .length,
                          itemBuilder: (context, index) => ReviewWidget(
                              data: snap.data!.handymanRatingReviewList
                                  .validate()[index],
                              isCustomer: true),
                        )
