...
use App\Repositories\CartRuleRepository;
use App\Repositories\CustomerGroupRepository;
use App\DataTables\CartRuleDataTable;
...
class CartRuleController extends Controller
{
     ...
     *
     * @param  App\Repositories\CartRuleRepository  $cartRuleRepository
     * @param  App\Repositories\CustomerGroupRepository  $customerGroupRepository
     * @return void
     */
    public function __construct(protected CartRuleRepository $cartRuleRepository, protected CustomerGroupRepository $customerGroupRepository)
    {
     ...
     */
    public function index(CartRuleDataTable $dataTable)
    {
    ...
    public function store(CartRuleRequest $cartRuleRequest)
    {
        try {
            ...
            session()->flash('success', trans('messages.response.create-success', ['name' => 'Cart Rule']));
    ...
    public function edit($id)
    {
        ...
        return view($this->_config['view'], compact('cartRule', 'customerGroups'));
    }
    ...
    public function update(CartRuleRequest $cartRuleRequest, $id)
    {
        try {
            ...
            session()->flash('success', trans('messages.response.update-success', ['name' => 'Cart Rule']));
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return response()->json(['message' => trans('messages.response.delete-success', ['name' => 'Cart Rule'])]);
        } catch (Exception $e) {}

        return response()->json(['message' => trans('messages.response.delete-failed', ['name' => 'Cart Rule'])], 400);
    }

    public function getConditionAttributes()
    {
        $attributes = $this->cartRuleRepository->getConditionAttributes();
    ...
    {
        $cartRules = $this->cartRuleRepository->findOrFail($cartRuleId);
