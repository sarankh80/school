...
class RepairComponent extends StatefulWidget {
  final List<ServiceData> serviceList;

  RepairComponent({required this.serviceList});

  @override
  State<StatefulWidget> createState() => _RepairComponentState();
}

class _RepairComponentState extends State<RepairComponent> {
  @override
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                ViewAllLabel(
                  label: language.lblRepairServices,
