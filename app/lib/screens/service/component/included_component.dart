...
class IncludeCompenent extends StatefulWidget {
  final ServiceData? serviceDetail;
  const IncludeCompenent({required this.serviceDetail, Key? key})
      : super(key: key);
  @override
  State<StatefulWidget> createState() => _IncludeCompenentState();
}

class _IncludeCompenentState extends State<IncludeCompenent> {
  @override
