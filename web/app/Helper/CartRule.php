...
use App\Repositories\CartRuleCustomerRepository;
use App\Repositories\CartRuleCouponUsageRepository;
...
class CartRule
{
     ...
     * @param  App\Repositories\CartRuleCouponRepository  $cartRuleCouponRepository
     * @param  App\Repositories\CartRuleCustomerRepository  $cartRuleCustomerRepository
     * @param  App\Repositories\CartRuleCouponUsageRepository  $cartRuleCouponUsageRepository
     * @param  App\Helper\Validator  $validator
     *
     * @return void
     */
    ...
    public function getCartRules($cart)
    {
        ...
        $cartRules = $this->getCartRuleQuery(optional($customerGroup)->id, core()->getCurrentChannel()->id);
