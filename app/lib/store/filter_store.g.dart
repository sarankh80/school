...
mixin _$FilterStore on FilterStoreBase, Store {
  ...
  late final _$setSelectedSub1CategoryAsyncAction =
      AsyncAction('FilterStoreBase.setSelectedSub1Category', context: context);

  @override
  Future<void> setSelectedSub1Category({required int catId}) {
    return _$setSelectedSub1CategoryAsyncAction
        .run(() => super.setSelectedSub1Category(catId: catId));
  }

  late final _$setSelectedSubBrandAsyncAction =
      AsyncAction('FilterStoreBase.setSelectedSubBrand', context: context);

  @override
  Future<void> setSelectedSubBrand({required int brandId}) {
    return _$setSelectedSubBrandAsyncAction
        .run(() => super.setSelectedSubBrand(brandId: brandId));
  }
