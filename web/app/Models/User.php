...
{
    use HasApiTokens, HasChildren, Favoriter, Notifiable, HasRoles, InteractsWithMedia,SoftDeletes, HasFactory;
     ...
     */
    protected $fillable = [
        'username', 'first_name', 'last_name', 'email', 'password', 'user_type', 'address', 'phone_number', 'email_verified_at', 'remember_token',
        'handymantype_id','player_id','country_id', 'state_id',  'city_id' , 'address', 'provider_id' , 'status', 'display_name', 'providertype_id' , 
        'is_featured' , 'time_zone' ,'last_notification_seen' , 'login_type','service_address_id' , 'uid','is_subscribe','social_image','is_available',
        'designation','last_online_time', 'customer_group_id'
    ];
    ...
    public function services(){
        return $this->hasMany(Service::class, 'added_by','id');
    }
    ...
    public function handymanAddressMapping(){
        return $this->belongsTo(Address::class, 'service_address_id','id');
    }
