      ...
      child: Column(
        children: [
          if (widget.couponData.isNotEmpty)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      widget.couponData[selectedIndex ?? 0].discountType ==
                              SERVICE_TYPE_FIXED
                          ? Text(
                              "${appStore.currencySymbol}${widget.couponData[selectedIndex ?? 0].discount.validate()} off",
                              style: primaryTextStyle())
                          : Text(
                              "${widget.couponData[selectedIndex ?? 0].discount.validate()}% off",
                              style: primaryTextStyle()),
                      16.height,
                      RichTextWidget(
                        list: [
            ...
            Text(language.lblNoCouponsAvailable, style: boldTextStyle())
                .center()
