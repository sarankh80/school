<x-master-layout>
    <div class="container-fluid">
        <div class="row">
            <div class="modal fade" id="providerModal" tabindex="-1" aria-labelledby="providerModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="providerModalLabel">{{ __('messages.dashboard_customizer') }}
                            </h5>
                        ...
                        <div class="modal-body">
                            ...
                            @if (
                                ($data['provider_dashboard_setting'] != [] && !empty($data['provider_dashboard_setting']->Top_Cards)) ||
                                    $show == 'true')
                            ...
                            @if (
                                ($data['provider_dashboard_setting'] != [] && !empty($data['provider_dashboard_setting']->Monthly_Revenue_card)) ||
                                    $show == 'true')
                                {{ Form::checkbox('Monthly Revenue card', 'monthly_revenue_card', true) }}Monthly
                                Revenue card<br>
                            @else
                                {{ Form::checkbox('Monthly Revenue card', 'monthly_revenue_card', false) }}Monthly
                                Revenue card<br>
                            @endif

                            @if (
                                ($data['provider_dashboard_setting'] != [] && !empty($data['provider_dashboard_setting']->Top_Services_card)) ||
                                    $show == 'true')
                                {{ Form::checkbox('Top Services card', 'top_service_card', true) }}Top Services card<br>
                            @else
                                {{ Form::checkbox('Top Services card', 'top_service_card', false) }}Top Services
                                card<br>
                            @endif

                            @if (
                                ($data['provider_dashboard_setting'] != [] && !empty($data['provider_dashboard_setting']->New_Handyman_card)) ||
                                    $show == 'true')
                                {{ Form::checkbox('New Handyman card', 'new_handyman_card', true) }}New Handyman
                                card<br>
                            @else
                                {{ Form::checkbox('New Handyman card', 'new_handyman_card', false) }}New Handyman
                                card<br>
                            @endif

                            @if (
                                ($data['provider_dashboard_setting'] != [] && !empty($data['provider_dashboard_setting']->Upcoming_Booking_card)) ||
                                    $show == 'true')
                                {{ Form::checkbox('Upcoming Booking card', 'upcoming_booking_card', true) }}Upcoming
                                Booking card<br>
                            @else
                                {{ Form::checkbox('Upcoming Booking card', 'upcoming_booking_card', false) }}Upcoming
                                Booking card<br>
                            @endif

                            @if (
                                ($data['provider_dashboard_setting'] != [] && !empty($data['provider_dashboard_setting']->New_Customer_card)) ||
                                    $show == 'true')
                                {{ Form::checkbox('New Customer card', 'new_customer_card', true) }}New Customer
                                card<br>
                            @else
                                {{ Form::checkbox('New Customer card', 'new_customer_card', false) }}New Customer
                                card<br>
                            @endif
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h5 class="mb-2 font-weight-bold text-primary">
                                                    {{ $data['dashboard']['count_total_booking'] }} </h5>
                                        ...
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon icon-shape bg-primary text-white rounded-circle shadow">
                                                <i class="ri-calendar-check-line"></i>
                                            </div>
                                            <a class="pt-2"
                                                href="{{ route('booking.index') }}">{{ __('messages.view_all') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h5 class="mb-2 font-weight-bold text-primary">
                                                    {{ $data['dashboard']['count_total_service'] }}</h5>
                                                <p class="mb-0 ml-3 text-success font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 text-secondary">
                                        ...
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon icon-shape bg-warning text-white rounded-circle shadow">
                                                <i class="ri-service-line"></i>
                                            </div>
                                            <a class="pt-2"
                                                href="{{ route('services.index') }}">{{ __('messages.view_all') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h5 class="mb-2 font-weight-bold text-primary">
                                                    {{ $data['dashboard']['count_total_provider'] }}</h5>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 text-secondary">
                                                {{ __('messages.total_name', ['name' => __('messages.handyman')]) }}
                                            </p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                                            <div
                                                class="iq-card-icon icon-shape bg-success text-white rounded-circle shadow">
                                                <i class="las la-user-friends"></i>
                                            </div>
                                            <a class="pt-2"
                                                href="{{ route('handyman.index') }}">{{ __('messages.view_all') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h5 class="mb-2 font-weight-bold text-primary">
                                                    {{ getPriceFormat(round($data['total_revenue'])) }}</h5>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 text-secondary">
                                        ...
                                        <div class="col-auto d-flex flex-column">
                                            ...
                                            <a class="pt-2"
                                                href="{{ route('providerpayout.index') }}">{{ __('messages.view_all') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                                ...
                                                <td class="p-2">
                                                    <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                        ...
                                                        <div class="data-content">
                                                            <div>
                                                                <span
                                                                    class="font-weight-bold">{{ optional($services->service)->name ?? '-' }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                    ...
                                    @else
                                        <div class="data-not-found">
                                            {{ __('messages.not_found_entry', ['name' => __('messages.service')]) }}
                                        </div>
                                    @endif
                                </tbody>
                            </table>
                                ...
                                <table class="table mb-0">
                                    <thead class="table-color-heading">
                                        <tr class="text-secondary">
                                            ...
                                            <th scope="col" class="white-space-no-wrap">
                                    ...
                                    <tbody>
                                        @foreach ($data['dashboard']['new_provider'] as $provider)
                                            <tr class="white-space-no-wrap">
                                                ...
                                                <td>{{ !empty($provider->phone_number) ? $provider->phone_number : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="card card-block card-height">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive max-height-400">
                                ...
                                @else
                                    <div class="data-not-found">
                                        {{ __('messages.not_found_entry', ['name' => __('messages.booking')]) }}</div>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive max-height-400">
                                                ...
                                                <tr class="white-space-no-wrap">
                                                    ...
                                                    <td>
                                                        <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                            <div class="h-avatar is-medium">
                                                                <img class="avatar rounded-circle" alt="user-icon"
                                                                    src="{{ getSingleMedia($customer, 'profile_image', null) }}">
                                                            </div>
                                                            <div class="data-content">
                                                                <div>
                                                                    <span
                                                                        class="font-weight-bold">{{ !empty($customer->display_name) ? $customer->display_name : '-' }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p
                                                            class="mb-0  d-flex justify-content-start align-items-center">
                                                            {{ !empty($customer->email) ? $customer->email : '-' }}
                                                        </p>
                                                    </td>
                                                    <td>{{ !empty($customer->phone_number) ? $customer->phone_number : '-' }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                @else
                                    <div class="data-not-found">
                                        {{ __('messages.not_found_entry', ['name' => __('messages.customerp')]) }}
                                    </div>
                                @endif
                            </div>
                        </div>
