<x-master-layout>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                {{ Breadcrumbs::render('edit_user', $customer->id) }}
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($customer, ['method' => 'PUT', 'route' => ['users.update', $customer->id], 'enctype' => 'multipart/form-data', 'data-toggle' => 'validator', 'id' => 'user']) }}
                        {{ Form::hidden('id') }}
