<x-master-layout>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                {{ Breadcrumbs::render('edit_admin', $admin->id) }}
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($admin, ['method' => 'PUT', 'route' => ['admins.update', $admin->id], 'enctype' => 'multipart/form-data', 'data-toggle' => 'validator', 'id' => 'user']) }}
                        {{ Form::hidden('id') }}
                        <div class="row">
