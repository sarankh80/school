@php
    $categories = null;
    $categoryRepository = app('App\Repositories\CategoryRepository');
                    ...
                    <div class="category-text-content">
                        ...
                        <ul type="none" class="fs14">
                            @foreach ($categories[0]->children as $subCategory)
                                <li>
                                    <a href="{{ $categories[0]->slug . '/' . $subCategory->slug }}"
                                        class="remove-decoration normal-white-text">
                                        {{ $subCategory->name }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <div class="category-text-content">
                        ...
                        <ul type="none" class="fs14">
                            @foreach ($categories[1]->children as $subCategory)
                                <li>
                                    <a href="{{ $categories[1]->slug . '/' . $subCategory->slug }}"
                                        class="remove-decoration normal-white-text">
                                        {{ $subCategory->name }}
                                    </a>
                                </li>
                    ...
                    <div class="category-text-content">
                        ...
                        <ul type="none" class="fs14">
                            @foreach ($categories[2]->children as $subCategory)
                                <li>
                                    <a href="{{ $categories[2]->slug . '/' . $subCategory->slug }}"
                                        class="remove-decoration normal-white-text">
                                        {{ $subCategory->name }}
                                    </a>
                                </li>
                    ...
                    <div class="category-text-content">
                        ...
                        <ul type="none" class="fs14">
                            @foreach ($categories[3]->children as $subCategory)
                                <li>
                                    <a href="{{ $categories[3]->slug . '/' . $subCategory->slug }}"
                                        class="remove-decoration normal-white-text">
                                        {{ $subCategory->name }}
                                    </a>
                                </li>
                        ...
                        <div class="category-text-content">
                            ...
                            <ul type="none" class="fs14">
                                @foreach ($categoryItem->children as $subCategory)
                                    <li>
                                        <a href="{{ $categoryItem->slug . '/' . $subCategory->slug }}"
                                            class="remove-decoration normal-white-text">
                                            {{ $subCategory->name }}
                                        </a>
                                    </li>
